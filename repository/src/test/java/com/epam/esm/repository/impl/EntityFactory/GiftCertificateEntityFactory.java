...
import static com.epam.esm.repository.impl.EntityFactory.TagEntityFactory.getNewTagEntityId1;
import static com.epam.esm.repository.impl.EntityFactory.TagEntityFactory.getNewTagEntityId2;
import static com.epam.esm.repository.impl.EntityFactory.TagEntityFactory.getNewTagEntityId5;
...
public class GiftCertificateEntityFactory {
    ...
    public static GiftCertificateEntity getNewGiftCertificateEntityId1() {
        return new GiftCertificateEntity(1, "Water skiing",
                ...
                LocalDateTime.parse("2022-04-27T04:43:55.000"), Stream.of(getNewTagEntityId1(), getNewTagEntityId2(), getNewTagEntityId7()).collect(Collectors.toList()));
    }
    ...
    public static GiftCertificateEntity getNewGiftCertificateEntityId2() {
        return new GiftCertificateEntity(2, "Car wash",
                ...
                LocalDateTime.parse("2022-04-27T04:43:55.000"), Stream.of(getNewTagEntityId5()).collect(Collectors.toList()));
    }
    ...
    public static GiftCertificateEntity getNewGiftCertificateEntityId3() {
        return new GiftCertificateEntity(3, "Relaxing massage \"Antistress\"",
                "Relaxing massage in Minsk will help to get rid of both nervous and muscle tension", 50.0, 60, LocalDateTime.parse("2022-04-27T04:43:55.000"),
                LocalDateTime.parse("2022-04-27T04:43:55.000"), Stream.of(getNewTagEntityId5()).collect(Collectors.toList()));
    }
    ...
    public static GiftCertificateEntity getNewGiftCertificateEntityId4() {
        return new GiftCertificateEntity(4, "Bowling for the company",
                ...
                LocalDateTime.parse("2022-04-27T04:43:55.000"), Stream.of(getNewTagEntityId5(), getNewTagEntityId7()).collect(Collectors.toList()));
    }
    ...
    public static GiftCertificateEntity getNewGiftCertificateEntity() {
        return new GiftCertificateEntity(0, "Name", "Description", 95.0, 60, LocalDateTime.parse("2020-04-27T04:43:55.000"),
                LocalDateTime.parse("2021-04-27T04:43:55.000"), Stream.of(getNewTagEntityId5(), getNewTagEntityId7()).collect(Collectors.toList()));
    }
