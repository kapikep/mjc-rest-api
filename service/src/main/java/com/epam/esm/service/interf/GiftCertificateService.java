...
public interface GiftCertificateService {
    ...
    void createGiftCertificate(@Valid GiftCertificateDto giftDto) throws ServiceException;
    ...
    void updateGiftCertificate(@Valid GiftCertificateDto giftDto) throws ServiceException;
